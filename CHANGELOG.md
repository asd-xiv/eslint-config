...
* Fixed `import/ignore` not being a rule, but a setting
...
[Unreleased]: https://github.com/asd14/eslint-config/compare/v5.0...HEAD

[5.0]: https://github.com/asd14/eslint-config/compare/v4.0.2...v5.0
